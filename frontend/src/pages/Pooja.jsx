        ...
        <div className="grid grid-cols-1 gap-8 max-w-2xl mx-auto">
          ...
          <div className="bg-white dark:bg-slate-900 border border-[#cca43b]/35 p-6 md:p-8 rounded-3xl shadow-md hover:shadow-xl hover:scale-[1.01] transition-all flex flex-col md:flex-row items-center md:items-start gap-5 relative overflow-hidden">
            ...
            <div className="space-y-3.5 text-center md:text-left">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed font-serif">
                ஒவ்வொரு வெள்ளிக்கிழமையும் மாலை 06:00 மணிக்கு சுவாமிக்கு சிறப்பு பூஜைகளும் அலங்கார ஆராதனைகளும் நடைபெறும். அனைத்து பக்தர்களும் கலந்து கொள்ள அன்புடன் அழைக்கப்படுகிறார்கள்.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-[#cca43b]/35 p-6 md:p-8 rounded-3xl shadow-md hover:shadow-xl hover:scale-[1.01] transition-all flex flex-col md:flex-row items-center md:items-start gap-5 relative overflow-hidden">
            ...
            <div className="space-y-3.5 text-center md:text-left">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed font-serif">
                ஒவ்வொரு பௌர்ணமி அன்றும் மாலை சுவாமிக்கு சிறப்பு அபிஷேகமும், மகா தீபாராதனையும் நடைபெறும். பக்தர்கள் அனைவரும் தங்களின் குடும்பத்தினருடன் வந்து சுவாமி தரிசனம் பெற வேண்டுகிறோம்.
              </p>
            </div>
          </div>
